'=============================================================
' modUploadFreezerRules - 凍乾機限制表 → EC2 SQLite
'=============================================================
' 注意: 此 Excel 第 2 列才是欄位名稱 (HEADER_ROW=2)
' 匯入此模組後，指派按鈕呼叫 UploadFreezerRules 即可
'=============================================================
Option Explicit
