            ...
            for row in qc_all:
                ...
                if name == base_name:
                    if any(str(row.get(col, "")).strip() for col in ["L1-OD","L2-OD","L1-起始OD","L2-起始OD"]):
                        ...
                        break
            if not selected_qc:
                selected_qc = {"L1-OD": None,"L2-OD": None,"L1-起始OD": None,"L2-起始OD": None}
