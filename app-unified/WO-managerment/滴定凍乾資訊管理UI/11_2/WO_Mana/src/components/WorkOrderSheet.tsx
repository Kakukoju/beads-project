...
// ✅ 完整版本：修復 QRCode error 並使用 BufferBaseTable 組件
...
export const WorkOrderSheet: React.FC<Props> = ({ data }) => {
  ...
  const { qrArray, qrValue, QR_FIELDS, EXPECTED_LEN } =
    useQRCodeData(data);
  ...
  return (
    ...
    >
      ...
      {/* ✅ 製劑 OD 檢查項目 - 使用 BufferBaseTable 組件（列印模式） */}
