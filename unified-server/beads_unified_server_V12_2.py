...
FILE_A_CONFIG = FileConfig(
    path=r"\\fls341\MBBU_FAB\MB_PD\生管自動化\滴定\祐銓\★2024-最新版【勿動】-BEADS庫存-20241126--20260106 NEW.xlsm",
...
def start_wip_nightly_job():
    ...
    scheduler.start()
    logger.info("✅ WIP nightly job @ 03:00")
...
def initialize_sync_service():
    ...
    try:
        ...
        logger.info("步驟 4/5:  WIP 03:00...")
        # start_wip_monitor()
        start_wip_nightly_job()
