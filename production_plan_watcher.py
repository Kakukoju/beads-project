...
DEFAULT_WATCH_DIR = (
    r"\\fls341\MBBU_FAB\MB_PD\生管自動化\滴定\production_plan"
)
DEFAULT_API_URL = (
...
def default_state_path() -> Path:
    ...
    if base:
        return Path(base) / "BeadsOps" / "production_plan_watcher_state.json"
    return Path.home() / ".beadsops" / "production_plan_watcher_state.json"
